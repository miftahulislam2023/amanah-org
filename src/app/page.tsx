...
import { Heart, Users, ArrowRight, Droplets, BookOpen, Stethoscope } from "lucide-react";

export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#2d5d45] to-[#1e402e] text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              মানবতার সেবায় <br />
              <span className="text-[#e2ae57]">আমানাহ ফাউন্ডেশন</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-green-100 leading-relaxed">
              দরিদ্র ও অসহায় মানুষের পাশে দাঁড়িয়ে একটি উন্নত সমাজ গড়ে তুলতে আমাদের সাথে যুক্ত হন
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="bg-[#e2ae57] text-gray-900 hover:bg-[#d19b3f]">
                <Link href="/donate">
                  এখনই দান করুন
                  <Heart className="w-5 h-5 ml-2" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" asChild className="border-white text-black hover:bg-white hover:text-[#2d5d45]">
                <Link href="/projects">
                  প্রকল্প দেখুন
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#2d5d45] mb-2">১০০+</div>
              <div className="text-gray-600">সফল প্রকল্প</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#2d5d45] mb-2">৫০০০+</div>
              <div className="text-gray-600">উপকারভোগী পরিবার</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#2d5d45] mb-2">২৫+</div>
              <div className="text-gray-600">জেলায় কাজ</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#2d5d45] mb-2">১০ বছর</div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center border-2 hover:border-[#e2ae57] transition-colors">
              <CardHeader>
                <div className="w-16 h-16 bg-[#2d5d45]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <BookOpen className="w-8 h-8 text-[#2d5d45]" />
                </div>
            ...
            <Card className="text-center border-2 hover:border-[#e2ae57] transition-colors">
              <CardHeader>
                <div className="w-16 h-16 bg-[#2d5d45]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Stethoscope className="w-8 h-8 text-[#2d5d45]" />
                </div>
            ...
            <Card className="text-center border-2 hover:border-[#e2ae57] transition-colors">
              <CardHeader>
                <div className="w-16 h-16 bg-[#2d5d45]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Droplets className="w-8 h-8 text-[#2d5d45]" />
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            <Card className="overflow-hidden">
              <div className="aspect-video bg-gradient-to-br from-[#2d5d45]/20 to-[#2d5d45]/30 flex items-center justify-center">
                <BookOpen className="w-12 h-12 text-[#2d5d45]" />
              </div>
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="text-sm text-[#2d5d45]">
                  উপকারভোগী: ৫০০+ শিশু
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden">
              <div className="aspect-video bg-gradient-to-br from-[#e2ae57]/20 to-[#e2ae57]/30 flex items-center justify-center">
                <Stethoscope className="w-12 h-12 text-[#e2ae57]" />
              </div>
              <CardHeader>
            ...
            <Card className="overflow-hidden">
              <div className="aspect-video bg-gradient-to-br from-[#be0027]/20 to-[#be0027]/30 flex items-center justify-center">
                <Droplets className="w-12 h-12 text-[#be0027]" />
              </div>
              <CardHeader>
      ...
      {/* Call to Action */}
      <section className="py-16 bg-[#2d5d45] text-white">
